...
AutoFill.prototype = {
	 ...
	 *  @param   {Node} nTd
	 *  @returns {Object} x and ui properties, for the position of the cell in the tables DOM
	 */
...
AutoFill.defaults = {
	/**
	 * Mode for dragging (restrict to ui-axis only, x-axis only, either one or none):
	 *
	 *  * `ui`      - ui-axis only (default)
	 *  * `x`      - x-axis only
	...
	column: {
		 ...
		 *   in the DataTable.
		 * @param  {integer} y Cell ui-position in the current auto-fill. The
		 *   starting cell is coordinate 0 regardless of its physical position
		 *   in the DataTable.
