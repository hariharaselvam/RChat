...
KeyTable = function ( oInit )
{
	...
	function _fnEventAddTemplate( sKey )
	{
		 ...
		 *           2. function:ui - callback function to apply
		 *         or
		 *           1. int:x - x coord. of target cell (can be null for live events)
		 *           2. int:ui - ui coord. of target cell (can be null for live events)
		...
		return function ( x, y, z ) {
			...
			{
				alert( "Unhandable event type was added: x" +x+ "  ui:" +y+ "  z:" +z );
			}
		};
	}
	...
	function _fnEventRemoveTemplate( sKey )
	{
		...
		return function ( x, y, z ) {
			...
			{
				alert( "Unhandable event type was removed: x" +x+ "  ui:" +y+ "  z:" +z );
			}
		};
	}
	 ...
	 *           int:ui - ui-coords to add event to - can be null for "blanket" event
	 ...
	 * Purpose:  Calulate the target TD cell from x and ui coordinates
	 ...
	 * Purpose:  Calculate the x and ui position in a table from a TD cell
	 * Returns:  array[2] int: [x, ui]
	 ...
	 * Returns:  array[2] int: [x, ui] coords. or null if not found
	 ...
	 *   array[2] int:focus - x and ui coordinates of the initial target
	 *     or
